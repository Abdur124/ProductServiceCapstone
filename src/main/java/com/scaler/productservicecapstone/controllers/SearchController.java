...
import com.scaler.productservicecapstone.dto.SearchRequestDto;
...
public class SearchController {
    ...
    public Page<ProductResponseDto> search(@RequestBody SearchRequestDto searchRequestDto) {
     ...
     Page<Product> productPage = searchService.search(searchRequestDto.getQuery(), searchRequestDto.getPageNumber(),
    ...
    @GetMapping("/search")
    public Page<ProductResponseDto> search(@RequestParam String query, @RequestParam int pageNumber, @RequestParam int pageSize, @RequestParam String sortParam) {
